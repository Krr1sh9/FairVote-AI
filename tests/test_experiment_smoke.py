...
def test_supported_grid_values_are_explicit() -> None:
    assert SUPPORTED_EPSILONS == (0.25, 0.5, 1.0, 2.0)
    assert SUPPORTED_SAMPLE_SIZES == (250, 500, 1000, 2000)
    assert SUPPORTED_BIAS_LEVELS == ("none", "moderate", "strong")
