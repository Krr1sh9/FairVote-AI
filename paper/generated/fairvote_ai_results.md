...
A separate privacy-help robustness curve is committed at `evidence/final/2026-05-05_182638_mrp_vs_baselines/`. It evaluates the `privacy_helps` scenario across epsilons 0.2, 0.5, 1.0 and 2.0 with 20 non-skipped trials per summary cell. This is the evidence source for any claim about privacy-level trade-offs under strategic misreporting.
