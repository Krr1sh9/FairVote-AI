...
> A reproducible research-engineering benchmark for evaluating locally-private polling estimators under sampling bias, nonresponse, sparse subgroup error, and strategic misreporting, with a new RR-aware hierarchical partial-pooling MRP estimator and controlled comparisons against linear, neural, oracle, and misreport-aware baselines.
...
| Report-ready output | `paper/fairvote_ai_results.md`, generated `paper/generated/fairvote_ai_results.md` after final evidence |
...
No claim below should appear in the final report unless the generated evidence files support it.
...
4. **Privacy/misreporting trade-off** — use `shy_privacy_helps` and `privacy_tradeoff` scenarios; report mixed or negative results honestly.
